...
Calendar addon version 1.1.4
Modified by jdleung 2006.05.23
Contact: jdleung@yahoo.com

CVS file version: $Id: calendar.php,v 1.13 2006/07/09 11:14:57 gajcy Exp $
...
$curr_month = (int) $_GET['curr_month'];
$curr_year = (int) $_GET['curr_year'];
...
if ( $_GET['showimage'] !="" && $_GET['curr_month'] ==""){
	...
	$curr_month = substr($img_datetime,6,1); 
       }
}   	
