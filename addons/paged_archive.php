...
CVS file version: $Id: paged_archive.php,v 1.12 2006/07/09 11:14:57 gajcy Exp $
...
$attention_call = "";
if ($table != "") {
if (isset($table_name)) $current_table = $table;
...
if (isset($thedate)){
    ...
    $archive_select = "<select name='browse'
    onChange='self.location.href=this.options[this.selectedIndex].value;'><option value=''>Monthly archive</option><option value='index.php?x=browse&amp;pagenum=1'>$lang_browse_all (" .$pixelpost_all_photonumb .")</option>";
    $archive_select_links = "<ul id=\"monthlist\">
                                <li><a href='index.php?x=browse&amp;pagenum=1'>$lang_browse_all (" .$pixelpost_all_photonumb .")</a></li>";
}
...
if($_GET['category'] != "") { $where = "and (t2.cat_id ='".(int)$_GET['category']."')"; }
